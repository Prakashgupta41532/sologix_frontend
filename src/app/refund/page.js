...
const page = () => {
  return (
    ...
    <div className="border-gray-500 w-11/12 m-auto">
      <p className="font-bold text-2xl underline tracking-wider text-center">Refund and Cancellation policy</p>
      <br></br>
      <p>
      ...
      <br></br>
      <p>
        1. Cancellations will only be considered if the request is made 30 days
        ...
        of shipping them, or the product is out for delivery. In such an event,
        you may choose to reject the product at the doorstep.
      </p>
      <br></br>
      <p>
        2. Sologix energy private limited does not accept cancellation requests
      ...
      <br></br>
      <p>
        3. Sologix energy private limited does not accept cancellation requests
        for perishable items like flowers, eatables, etc. However, the refund /
        replacement can be made if the user establishes that the quality of the
        product delivered is not good.
      </p>
      ...
      <br></br>
      <p>
        5. In case of any refunds approved by Sologix energy private limited, it
        will take 15 days for the refund to be processed to you.
      </p>
      <br></br>

      <p className="font-bold text-2xl underline tracking-wider text-center">Return Policy</p>
      <br></br>
      <p>
        We offer refund / exchange within first 45 days from the date of your
        purchase. If 45 days have passed since your purchase, you will not be
      ...
      <p className="font-bold text-2xl underline tracking-wider text-center">Shipping Policy</p>
      <br></br>
      <p className="mb-3">

...
const Invoice = ({ crossPress, price }) => {
    ...
    return (
        <div className="relative max-w-4xl mx-auto my-10 p-6 bg-white shadow-lg rounded-lg text-sm text-gray-700">
            <button
                onClick={(e) => {
                    e.stopPropagation();
                    crossPress();
                }}
                className="absolute top-1 right-0 w-5 h-5 rounded bg-red-600 text-white flex items-center justify-center hover:bg-red-700 transition"
            >
                X
            </button>

            <div className="flex justify-between items-center border-b pb-4 mb-4">
                <Image src={img} alt="Logo" className="h-auto max-w-[120px]" />
